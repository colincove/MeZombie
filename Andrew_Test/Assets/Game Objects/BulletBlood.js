...
if(target!=null){
	var randomAllow = Random.Range(0, 100);
		if (randomAllow<30){ //30% chance blood will splatter
			...
			Instantiate(bloodSplatter, new Vector3(target.transform.position.x+randomX,target.transform.position.y+randomY,target.transform.position.z), Quaternion.identity );
